...
private Resources theme;
    public Menu() {
        ...
        getToolbar().addCommandToSideMenu("Coupons", null, ev -> { new CouponsList(this).show(); } );
         ...
         getToolbar().addCommandToSideMenu("Reclamations", null, ev -> { new ListReclamation(this).show(); } );
         
        ArticleDao articleDao = new ArticleDao();
        ArticleService articleService = new ArticleService();
        
       // getToolbar().addCommandToSideMenu("Articles", null, ev -> { new AddArticleForm(this, articleService).show();  });
        getToolbar().addCommandToSideMenu("Articles", null, ev -> { new ArticleListForm(this).show();});
